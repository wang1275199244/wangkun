            ...
            if(riid != null&&rid != null&&riid != 0&&rid != 0) {
                ...
                if(jobApplication != null){
                    ...
                    if(resume != null) {
                        ...
                        Employee employee = new Employee(resume.getPhone(),pass,resume.getName(),resume.getSex(),age,resume.getPhone(),resume.getEmail(),department.getId(),position.getId(),state1);
